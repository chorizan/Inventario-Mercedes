...
export const useProductosStore = create((set, get) => ({
  ...
  incrementarStockPorCodigo: async (p) => {
    const response = await IncrementarStockPorCodigo(p);
    // refrescar listado si es necesario
    const { mostrarProductos, parametros } = get();
    if (parametros) set(mostrarProductos(parametros));
    return response;
  },
